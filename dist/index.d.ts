...
export declare const range: (end: number, start?: number | undefined, step?: number) => number[];
...
export declare const splitWords: (sentence: string) => string[];
export declare const capitalize: (word: string) => string;
export declare const capitalizeFirst: (sentence: string) => string;
export declare const capitalizeAll: (sentence: string, ...exceptions: string[]) => string;
